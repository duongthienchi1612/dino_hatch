...
class Cube extends StatefulWidget {
  Cube({Key? key, this.interactive = true, this.onSceneCreated, this.onObjectCreated}) : super(key: key);
...
class _CubeState extends State<Cube> {
  ...
  void _handleScaleUpdate(ScaleUpdateDetails details) {
    ...
    setState(() {});
    // _isInteracting vẫn giữ true cho đến khi onScaleEnd
  }
  ...
  void initState() {
    super.initState();
    scene = Scene(onUpdate: () => setState(() {}), onObjectCreated: widget.onObjectCreated);
